    ...
    return(
        <div className="min-h-[calc(100vh-70px)] flex flex-col md:flex-row justify-center items-center">
               ...
               className="max-w-full h-auto"
                />
                <p className="text-slate-800 text-center font-montserrat lg:text-4xl text-2xl font-bold mr-5.5"><span className="text-violet-600">New Here?</span> Let's Get You <span className="text-green-500">Signed Up</span></p>
             </div>
